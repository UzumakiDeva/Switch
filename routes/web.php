...
Route::get('/underconstruction', function () {
    return view('undermantain');
});


Route::get('/stakeupdatetest','HomeController@stakelist');
Route::get('/stakebalance','HomeController@stakebalance');
Route::get('/stakesetestimate','HomeController@stakesetEstimate');


// Route::get('/stacking', function () {
//     return view('staking.stacking');
// });

// Route::get('/cryptosavings', function () {
//     return view('staking.cryptosavings');
// });


//staking
Route::get('/staking', 'StackController@stakingproduct');
Route::get('/stacksubscribepage/{id}', 'StackController@stacksubscribepage');
Route::post('/stacksubmit', 'StackController@stacksubmit');
Route::get('/staking-history', 'StackController@stake_history');
Route::get('/staking-account', 'StackController@stake_account');
Route::get('/stakedailyreward', 'StackController@stakedailyreward');
Route::get('/earning', 'StackController@earnings');
Route::get('/earninghistory/{type}', 'StackController@earninghistory')->name('earningHistory');
Route::get('/cancelstake/{id}', 'StackController@CancelStack');
Route::post('stakewithdraw','StackController@stakewithdraw');
...
Route::get('2faverification/googe2faenable', 'TwofaController@enableGoogleTwoFactor')->name('googe2faenable');
Route::get('2faverification/googe2faotp', 'TwofaController@enableGoogleTwoFactorotp')->name('googe2faotp');
Route::post('2faverification/googe2faverifyotp', 'TwofaController@verifyGoogleTwoFactorotp')->name('googe2faverifyotp');

// Email 2FA
Route::get('2faverification/email2faenable', 'TwofaController@enableEmailTwoFactor')->name('email2faenable');
Route::get('2faverification/email2fadisable', 'TwofaController@disableEmailTwoFactor')->name('email2fadisable');
...
Route::get('/p2p-paymentnotreceived/{orderID}', 'P2PMarketplaceController@notReceived');
...
Route::get('trading-chart/{pair}','TradeController@tradingViewChart');
Route::get('market-chart/{pair}','TradeController@marketDepthChart');
...
//instantswap
Route::get('swap','SwapController@listcoin')->name('swap');
Route::post('getbalance','SwapController@getbalance');
Route::post('swapsubmit','SwapController@SwapTrade');
Route::get('listcoin/{value}','SwapController@pairlist');
Route::get('/swap-history', 'HistroyController@swap');
