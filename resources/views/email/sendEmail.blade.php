...
<tr><td align='center'>&nbsp;</td><td align='center'><a href="{{route('sendEmailDone', ['email' => \Crypt::encryptString($user->email), 'verifyToken' => $user->id])}}" style='color:#fff;padding:14px 22px;text-decoration:none;background:linear-gradient(109.54deg, #efbb71 -3.62%, #b68549 93.53%);border-color: #b38247 !important;text-transform:uppercase;font-size:15px;font-weight:600;'>Click to Verify</a></td><td align='center'>&nbsp;</td></tr>
<tr><td colspan='3' align='center' height='30' style='padding:0px;'></td></tr>
