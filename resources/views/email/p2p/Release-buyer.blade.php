...
<tr>
	...
	<td style='text-align:left;font-size:15px;color:#000;padding-top:0px;'>Seller released fund to  for your Buy Order!</td>
	<td align='left' style='padding-top:0px;'>&nbsp;</td>
</tr>
<tr><td align='left' style='padding-top:0px;'>&nbsp;</td><td colspan='3'>
	<table align='center' width="90%" style="border-collapse:collapse;margin-left:auto;margin-right:auto">
		...
		<tr style="border-bottom:1px dashed #d7d7d7"><td>Matched Trade :</td><td>{{ display_format($escrow_volume ,$selectPair->coinone_decimal) }} {{ $selectPair->coinone }}</td></tr>
		...
		<tr style="border-bottom:1px dashed #d7d7d7"><td>Net :</td><td>{{ display_format($escrow_volume ,$selectPair->coinone_decimal) }} {{ $selectPair->coinone }}</td></tr>
		<tr style="border-bottom:1px dashed #d7d7d7"><td>Status :</td><td>Waiting for payment</td></tr>
		<tr style="border-bottom:1px dashed #d7d7d7"><td>Time :</td><td>30 minutes</td></tr>
	</table>
