...
@endif
  ...
  @endif
    ...
    <div>      
      <h5 class="sellers-head">Waiting for Seller Release Fund</h5>
      <hr>
      <p class="buy-order">We will email you when your order is complete.</p>
    ...
    <p class="time-txt">Time taken minumum 30 mins</p>
