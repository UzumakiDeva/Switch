  ...
  <div class="container sitecontainer">
    ...
    <section class="order-book-table">
      <div class="contain-width">
        ...
        <div class="row">
        <div class="col-sm-12 col-md-12 col-xl-4 col-lg-4" id="Market-Depth">
        ...
        <div class="tab-menu">
           ...
           <div class="tab tab-active" data-id="tab1" id="volume-buy-price">
...
<table class="table">
        ...
        <div class="col-sm-12 col-lg-4 col-md-12 col-xl-4">
          <div overflow="hidden" height="352px" class="sc-gsTEea ustd-button">
            <div height="56px" class="sc-gsTEea grp-button">
              ...
              <div class="sc-gsTEea sc-cHjwLt  known-video keSexs">{!! $symbol !!}{{$selectPair->live_price}}</div></div>
              <div class="sc-gsTEea gIthqj"><span font-size="20px" color="var(--color-text-l0)" class="sc-bdfBQB kOQuca">P2P Markets</span>
                <span font-size="12px" color="var(--color-text-l1)" class="sc-bdfBQB jaGfxD">Use switchExchange P2P when you want to buy {{$coinone}} to trade cryptos, or when you want to sell {{$coinone}} and cash out to {{$cointwo}}. It's safe and hassle free!</span>
                <div class="sc-edoYdd jXXMqd">How it works</div>
                 <div class="flex-payment">
                  <div class="account"><img src="{{ url('img/bank-account.svg') }}" alt="how-it-bank-account-works" class="works"><p>Pay directly to seller bank account</p></div>
                  <div class="account"><img src="{{ url('img/confirms-payment.svg') }}" alt="how-it-works-confirms-payment" class="works"><p>Seller confirms payment</p></div>
                  <div class="account"><img src="{{ url('img/USDT-to-account.svg') }}" alt="how-it-works-USDT-to-account" class="works"><p>Switch releases locked USDT to your account</p></div>
                 </div>
  ...
  <section class="login-sctn">
   ...
   <div class="panelcontentbox buyers-sellers-tabs">
      <div class="innerpagetab historytab">
						<ul class="nav nav-tabs tabbanner buyers-sellers-tabs-inner" role="tablist">
						<li class="nav-item active"><a class="nav-link active" data-bs-toggle="tab" href="#USDTmarket" data-bs-target="#USDTmarket">Buyers</a></li>
          ...
          <thead>
            ...
            <tbody>
              ...
              <tr onclick="javascript:buyRow('{{ $buytrade->price }}','{{ $buytrade->remaining }}');">
            ...
            <table class="table sitetable">
              ...
              <tr onclick="javascript:sellRow('{{ $selltrade->price }}','{{ $selltrade->remaining }}');">
    ...
    <div class="col-sm-12 col-lg-4 col-md-12 col-xl-4" id="open-orders-id">      
      <!-- <ul class="tabs open-orders">
        <li data-num=".one" class="open-box active">Open Orders</li>
        <li data-num=".two" class="open-box">Completed Orders</li>
      </ul> -->

    <div class="innerpagetab historytab tabs open-orders">
    <ul class="nav nav-tabs tabbanner buyers-sellers-tabs-inner" role="tablist">
    <li class="nav-item active"><a class="nav-link active" data-bs-toggle="tab" href="#OpenOrders" data-bs-target="#OpenOrders">Open Orders</a></li>
    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#CompletedOrders" data-bs-target="#CompletedOrders">Completed Orders</a></li>
    </ul>
    </div>
...
<div class="overflow-auto-block">
<table class="table market-depth-table" style="margin-top:0px !important">
                <tbody>
                  ...
                  <tr class="my-orders-{{ strtolower($opentrade->trade_type) }}">
                    ...
                    <td class="my-orders">{{ $opentrade->price }}</td>
                    <td class="my-orders"><a href="{{ url('/p2p-matchorder/'.$opentrade->order_id) }}"> <span class="badge badge-warning">{{ $opentrade->status_text }}</span></a></td>
                  </tr>
                  @empty
                  <tr>
    ...
    @endguest
      ...
      <div class="col-sm-12 col-lg-4 col-md-12 col-xl-4">
        ...
        <div class="form-details">
            ...
            <div class="innerpagetab historytab buy-sell-tab-content-tab-head">
						<ul class="nav nav-tabs tabbanner buyers-sellers-tabs-inner" role="tablist">
						<li class="nav-item buyli active"><a class="nav-link active" data-bs-toggle="tab" href="#buytab" data-bs-target="#buytab">Buy</a></li>
						<li class="nav-item sellli"><a class="nav-link" data-bs-toggle="tab" href="#selltab" data-bs-target="#selltab">Sell</a></li>
						</ul>
			</div>

			<div class="tab-content buy-sell-tab-content-tab">
...
$('button.btn.btn-block.sitebtn.green-btn').click(function(){
...
$('#buyprice_dis').text(buyprice);
$('#buyvolume_dis').text(buyvolume);
$('#buytotal_dis').text(buytotal);
...
<script>
  ...
  document.getElementById("defaultBuy").click();
</script>
...
function sellRow(price,remaining)
  {
    ...
    var buytotal = parseFloat(price) * parseFloat(remaining);
    buytotal = parseFloat(buytotal).toFixed(coinTwoDecimal);
    document.getElementById("buytotal").value = buytotal;

    document.getElementById('buy_price').value = price;
    document.getElementById('buy_quantity').value = remaining;
    ...
    $('.buy-sell-tab-content-tab-head .buyli').addClass('active');
    $('.buy-sell-tab-content-tab-head .sellli').removeClass('active');
    $('.buy-sell-tab-content-tab-head .buyli a').addClass('active');
    $('.buy-sell-tab-content-tab-head .sellli a').removeClass('active');
  ...
  function buyRow(price,remaining)
  {
    ...
    var selltotal = parseFloat(price) * parseFloat(remaining);
    selltotal = parseFloat(selltotal).toFixed(coinTwoDecimal);
    document.getElementById("selltotal").value = selltotal;

    document.getElementById('sell_price').value = price;
    document.getElementById('sell_quantity').value = remaining;
    ...
    $('.buy-sell-tab-content-tab-head .buyli').removeClass('active');
    $('.buy-sell-tab-content-tab-head .sellli').addClass('active');
    $('.buy-sell-tab-content-tab-head .buyli a').removeClass('active');
    $('.buy-sell-tab-content-tab-head .sellli a').addClass('active');
    // document.getElementById("defaultSell").click();
    sellcal();
