@php $title = "Outstanding History"; $atitle ="p2phistory";
@endphp
						...
						<div class="panelcontentbox">
							<div class="innerpagetab">
								<ul class="nav nav-tabs tabbanner" role="tablist">
									<li class="nav-item"><a class="nav-link active" href="{{ route('p2phistory') }}">Outstanding</a></li>
									<li class="nav-item"><a class="nav-link" href="{{ route('success') }}">Successful</a></li>
										...
										<form class="siteformbg" method="post" autocomplete="off">
											<div class="searchfrm row">
												<div class="col-xl-3 col-lg-4 col-md-4">
													<div class="form-group">
														<div class="input-group dateinput">
															<input class="form-control" name="start_date" placeholder="Start Date (DD-MM-YYYY)">
												...
												<div class="col-xl-3 col-lg-4 col-md-4">
													<div class="form-group">
														<div class="input-group dateinput">
															<input class="form-control" name="end_date" placeholder="End Date (DD-MM-YYYY)">
										...
										<table class="table sitetable table-responsive-stack" id="table1">
											...
											@forelse($historys as $history)
												<tr>
													...
													@if($history->trade_type == 'Buy')
													<td>
														<a class="badge badge-success" href="{{ url('p2pbuyerinfo/'.Crypt::encrypt($history->id)) }}">View</a></td>	

													@else
													<td>
														<a class="badge badge-success" href="{{ url('p2psellerinfo/'.Crypt::encrypt($history->id)) }}">View</a></td>
													@endif					
