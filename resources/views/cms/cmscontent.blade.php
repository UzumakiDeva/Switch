...
<section class="anti-money-full">
          <div class="anti-money">
            <div class="container-fluid">
                     ...
                     <h1 class="anti-head">{{$Content->title}}</h1>
  ...
  <div class="contain-width">
    ...
    <div class="row">
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 copy-left">
        ...
        <li class="nav-item">
          <a class="nav-link footer" href="{{ url('/page/security') }}">Security </a>
          <a class="nav-link footer" href="{{ url('/page/terms-conditions') }}">Term of Use</a>
          <a class="nav-link footer" href="{{ url('/page/aml') }}">AML & KYC Policy </a>
