						...
						<div class="panelcontentbox">
							<div class="innerpagetab">
								<ul class="nav nav-tabs tabbanner" role="tablist">
									...
									<li class="nav-item"><a class="nav-link" href="{{ url('swap-history') }}">Swap History</a></li>
							...
							<div class="tab-content">
								<div id="trade" class="tab-pane fade in show active">
									<div class="searchfrmbox">
										<form class="siteformbg" action="{{url('trade-search')}}" method="post" autocomplete="off">
											@csrf
											<div class="searchfrm row">
												<div class="col-xl-3 col-lg-4 col-md-4">
													<div class="form-group">
														<div class="input-group dateinput">
															<input class="form-control" name="startdate" placeholder="Start Date (YYYY-MM-DD)" value="{{$start_date}}">
															<div class="input-group-append" data-toggle="datepicker3" data-target-name="startdate"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
														</div>
													</div>
												</div>
												<div class="col-xl-3 col-lg-4 col-md-4">
													<div class="form-group">
														<div class="input-group dateinput">
															<input class="form-control" name="enddate" placeholder="End Date (YYYY-MM-DD)"  value={{$end_date}}>
															<div class="input-group-append" data-toggle="datepicker3" data-target-name="enddate"><span class="input-group-text"><i class="fa fa-calendar"></i></span></div>
														</div>
													</div>
												</div>
												...
												<div class="col-xl-3 col-lg-4 col-md-4">
													<div class="form-group">
														<select class="form-control" name="type">
															<option value="All" @if($type==='All')selected @endif>All Side</option>
												...
												<div class="col-xl-3 col-lg-4 col-md-4">
													<div class="form-group">
														<select class="form-control" name="pair">
															...
															<option value="{{$tabtrade->coinone.'_'.$tabtrade->cointwo}}" @if($Pair == $tabtrade->coinone.'_'.$tabtrade->cointwo) selected @endif>{{$tabtrade->coinone.'/'.$tabtrade->cointwo}}</option>															
															@empty
												...
												<div class="col-xl-3 col-lg-4 col-md-4 clearbtn">
													<div class="form-group">
														<button type="submit" class="btn sitebtn btn-sm">Search</button> <a href="{{url('trade-histroy')}}" class="btn sitebtn btn-sm">Reset</a></div>
												</div>
											</div>
										</form>
									</div>
