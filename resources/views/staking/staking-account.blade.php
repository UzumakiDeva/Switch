						...
						<div class="panelcontentbox">
							<div class="innerpagetab">
								<ul class="nav nav-tabs tabbanner" role="tablist">
									<li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#trade" data-bs-target="#trade">Account</a></li>
								</ul>
							</div>
										...
										<table class="table sitetable table-responsive-stack" id="table1">
											...
											<tbody>
												...
												<tr>
													...
													<td>{{ $value->staking_title }}</td>
													<td>{{ $value->deposit_coin }}</td>
													<td>{{ $value->actual_staking_amount }}</td>
													<td>{{ $value->no_of_coin }}</td>
													<td>{{ $value->duration_title }}</td>
													<td>{{ $value->expiry_date }}</td>
													<td>{{ $value->last_reward }}</td>
													<td>{{ $value->next_reward }}</td>
													<td>---</td>
												</tr>
												@endforeach
												@else
