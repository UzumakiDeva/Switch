						...
						<form class="siteformbg">
							<div class="row">
								...
								<div class="col-xl-5 col-lg-6 col-md-6 pl-4 pr-4">
									...
									<div class="form-group mt-4 ERC20">
										<img src="https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl={{ $ethaddress }}" class="qrcode-bg"/>
										<a href="https://chart.googleapis.com/chart?chs=250x250&cht=qr&chl={{ $ethaddress }}" class="btn sitebtn mx-2" download>Download</a>
									</div>
							...
							<div class="form-group notestitle">																				
								<p class="text text-danger">Disclaimer</p>
									...
									<li>Transaction might take 12 to 15 minutes to confirm depends on the network speed.</li>
									@if($payment_id !='')
