				...
				<div class="container sitecontainer">
					...
					<div class="flexbox supportbg pbg">
						<div class="panelcontentbox supportticketlist">
							...
							<div class="p-img text-center p-4 profile-badge-image">
								@if(Auth::user()->profileimg)
								<img src="{{ Auth::user()->profileimg }}" alt="" class="profilebg">
								@else
								<img src="{{ url('images/pro.svg') }}" alt="" class="profilebg">
								@endif
								
								@if ( $user->role == 'Ex_Manager') 
								<div class="my-profile-badge"><img src="{{ url('images/badge-profile-excutive.png') }}" alt="" class="profilebg"></div>
								@elseif ($user->role == 'SR_Manager') 
								<div class="my-profile-badge"><img src="{{ url('images/badge-profile-senior.png') }}" alt="" class="profilebg"></div>
								@elseif ($user->role == 'Club_Manager') 
								<div class="my-profile-badge"><img src="{{ url('images/badge-profile-club.png') }}" alt="" class="profilebg"></div>
								@elseif ($user->role == 'Cheif_Manager') 
								<div class="my-profile-badge"><img src="{{ url('images/badge-profile-chief.png') }}" alt="" class="profilebg"></div>
								@endif
