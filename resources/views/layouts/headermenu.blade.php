...
<section class="headermenu">
	...
	<img src="{{ url('landing/img/logo-dark.png') }}" class="light-logo">
			...
			<div class="collapse navbar-collapse" id="collapsibleNavbar">
				...
				<li  class="nav-item"><a href="{{ route('swap') }}" class="nav-link @if($active == 'swap') active @endif">Swap</a></li>
				<li  class="nav-item"><a href="{{ route('tradehistroy') }}" class="nav-link @if($active == 'history') active @endif">History</a></li>
				
				<li  class="nav-item"><a href="{{ url('staking') }}" class="nav-link @if($active == 'staking') active @endif">Staking </a></li>	
				<!-- <li  class="nav-item"><a href="{{ url('stacking') }}" class="nav-link @if($active == 'stacking') active @endif">Stacking</a></li> -->
				...
				<div class="sun-moon-icon">
					<ul>
				@if(Session::get('mode')=='nightmode')
				<li><a href="{{ url('/setmode/daymode') }}"><img src="{{ url('landing/img/sun-icon.svg') }}" class="img-fluid sun-img" id="showf"  aria-hidden="true">   </a></li>                 
        @else
		<li><a href="{{ url('/setmode/nightmode') }}"><img src="{{ url('landing/img/moon-icon.svg') }}" class="img-fluid moon-img" id="showf"  aria-hidden="true"></a></li>
        @endif
		</ul>
		</div>
				...
				<ul class="navbar-nav">
					<li class="dropdown usermenu"> <a href="#" class="nav-link dropdown-bs-toggle" data-bs-toggle="dropdown">{{ Auth::user()->first_name .' '.Auth::user()->last_name}}
						@if(Auth::user()->profileimg)
									<span class="photopic"><img src="{{Auth::user()->profileimg}}"  alt="user-image" class="img-circle img-inline"></span></a>
									@else
						...
						<div class="dropdown-menu"> 
						 ...
						 <a class="nav-link dropdown-item" href="{{url('earning')}} "><i class="fa fa-money"></i>Earning</a> 
						 <a class="nav-link dropdown-item" href="{{url('referral-info')}} "><i class="fa fa-user"></i>Referral Information</a>
