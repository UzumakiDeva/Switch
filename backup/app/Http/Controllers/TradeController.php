...
class TradeController extends Controller
{
    ...
    public function Update_tradehistory(Request $request){
        ...
        return view('tradehistory-update',['completes' => $complete]);
        ...
        if ($buytrades) {
            ...
            if($trdepair->is_type == 1){
                ...
                if($check->success == "true"){
                    ...
                    $this->creditAmountPending($uid, $currency, $total, $fee,$leve_bal,'buy',$pairname);          
        ...
        if ($selltrades) {
            ...
            if($trdepair->is_type == 1){           
                ...
                if($check->success == "true"){
                    ...
                    $pairname   = $trdepair->coinone.'/'.$trdepair->cointwo;
                    $this->creditAmountPending($uid, $currency, $total, $fee,$leve_bal,'sell',$pairname);
   ...
   public function creditAmountPending($uid, $currency, $balance, $escrow,$leverage,$tradetype,$pairname = null) {
        ...
        $this->AllcoinUpdateBalanceTrack($uid,$currency,$balance,$walletbalance,$oldbalance,$tradetype,$pairname,$userbalance->id);
    ...
    public function AllcoinUpdateBalanceTrack($uid,$currency,$amount,$walletbalance,$oldbalance,$tradetype,$pairname,$insertid)
    {
        ...
        $type = 'trade';
        $Models::AddTransaction($uid,$currency,$type,$amount,0,$walletbalance,$oldbalance,$remark,'user',$insertid);
