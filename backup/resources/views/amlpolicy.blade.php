...
<section class="anti-money-full">
          <div class="anti-money">
            <div class="container-fluid">
              
                     <h1 class="anti-head">Anti-Money Laundering (AML) Policy</h1>
       ...
       <div class="para-content">
            <div class="container">
                <div class="anti-para-txt">
                  
                      <p class="para-cnt">Panther Exchange  AML Policy is designed to prevent money laundering, including the need to have adequate systems and controls in place to mitigate the risk of the firm being used to facilitate financial crime. This AML Policy sets out the minimum standards which must be complied with and includes: </p></li>
                       
                      <ul>
                      <li>
                        <p class="para-cnt">The appointment of a Money Laundering Reporting Officer (MLRO) who has a sufficient level of seniority and independence and who has responsibility for oversight of compliance with relevant legislation, regulations, rules and industry guidance;</p></li>
                       <li>
                         <p class="para-cnt">
                        ...
                        <li>  
                             <p class="para-cnt">Establishing and maintaining risk-based customer due diligence, identification, verification and know your customer (KYC) procedures, including enhanced due diligence for those customers presenting higher risk, such as Politically Exposed Persons (PEPs);
                         </p></li>
            
                      <li> 
                   <p class="para-cnt">Procedures for reporting suspicious activity internally and to the relevant law enforcement authorities as appropriate;
                   </p>
                   </li>

                   <li> 
                    <p class="para-cnt">The maintenance of appropriate records for the minimum prescribed periods;
                    </p>
                    </li>

                    <li> 
                        <p class="para-cnt">Training and awareness for all relevant employees
                        </p>
                        </li>
                        </ul>
                ...
                <div class="sub-terms">
                    ...
                    <span class="align-self-center">Counter Financing of Terrorism (CFT)</span>
                        </h5>
                     </div>
                     <div class="para">
                        <span class="number">1.1</span>
                        <p class="money-para">The Company takes a risk-based approach when adopting and implementing counter-financing of terrorism (CFT) measures and in conducting AML risk assessments.
 
                        </p>
                     </div>
                     <div class="para">
                        <span class="number">1.2</span>
                        <p class="money-para">The company adopted internal CFT controls and makes undefended decisions regarding CFT matters supersede any business, strategic, or other operating task.
                        </p>
                     </div>
                </div>
                ...
                <div class="sub-terms">
                    <div>
                        <h5 class="heading">
                            ...
                            <span class="align-self-center"> International Sanctions Policy (ISP)</span>
                        </h5>
                     </div>
                     <div class="para">
                        <span class="number">2.1</span>
                        <p class="money-para">Our company is prohibited from transacting with individuals, companies and countries that are on prescribed sanctions lists. 
                ...
                <div class="sub-terms">
                    <div>
                     ...
                     <div class="para">
                        <p class="money-para">
                            <ol class="list-content">
                                <li> A passport, ID, or driver's license to confirm your identity.</li>
                                <li> A photo, where you are holding  your document and a piece of paper with the handwritten date and name of our platform (an example is attached)</li>
                             <li>A bank account statement, utility bill (electricity, water, internet, etc) with your name or any other document to confirm your address. You may submit a picture of a hard copy bill or a PDF of a paperless bill.
                            </li>
                            </ol>
                         </p>
                     ...
                     <div class="para">
                        ...
                        <p class="money-para"> Verification is optional and is not required to use the platform. You can deposit, trade, and withdraw without passing verification (KYC). The only limit is that you can't withdraw more than 1 BTC per 24h without passing a verification (KYC)</p>
                        </div>
                        <div class="para">
                            <span class="number">2.</span>
                            <p class="money-para"> Panther Exchange  does not technically serve the following countries: the Russian Federation and Crimea, the United States of America, Cuba, Iran, Iraq, North Korea, Sudan, Syria, Pakistan, Sudan and Kazakhstan. Verification for these countries is also not possible, so documents of users from these countries will not be accepted for verification.</p>
                        </div>       
                       <div class="para">
                        <span class="number">3.</span>
                        <p class="money-para">  The verification process may take up to 24 hours (in some cases even longer than 24 hours, due to numerous documents to be manually reviewed by the customer support team)
                        </p>
                       </div>
                           <div class="para">
                            <span class="number">4.</span>
                            <p class="money-para">Text information about you, that you fill in during passing verification here <a href="#">https://panther-exchange.io/account/verification/individual </a>, namely: First Name, Last Name, Middle Name (if you have), Country / State, City, Street, and Zip Code, must necessarily match the information that is indicated in your documents. Only in this case, you will be successfully verified.</p>
                           </div>
                         <div class="para">
                            <span class="number">5.</span>
                            <p class="money-para">The platform's security policy reserves the right to require KYC to protect funds in case of suspicious activity on the account. Before passing KYC, all account activity may be suspended.</li>
                         </div>
...
<script type="application/ld+json">
    {
        ...
        "mainEntity": [
            {
                "@type": "Question",
                "name": "What is a trust wallet clone script?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Trust wallet clone script is a ready-made wallet script developed by opris tha" +
                            "t functions similarly to the trust wallet. It allows businesses and entreprene" +
                            "urs to quickly launch their own cryptocurrency wallet without having to build " +
                            "it from scratch. This trust wallet clone script is built with a hassle and bug" +
                            "-free clone script."
                }
            }, {
                "@type": "Question",
                "name": "Can I get a QR scanner with a trust wallet clone?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "This feature is already in the built-in opris trust wallet clone script. You c" +
                            "an even customize some add-on features into this clone including a QR scanner."
                }
            }, {
                "@type": "Question",
                "name": "Does opris ready-made trust wallet clone script have the best security?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Yes! It offers the best security integrated features like CSRF protection, DDo" +
                            "S mitigation, Anti-phishing, escrow wallet, and end-to-end encryption in ready" +
                            "made trust wallet clone script."
                }
            }, {
                "@type": "Question",
                "name": "What is the approximate time duration to launch a wallet like a trust wallet?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "With the help of opris trust wallet clone script, you can quickly develop a cr" +
                            "ypto wallet that functions similarly to a trust wallet. But, depending on your" +
                            " unique needs, this time frame can change."
                }
            }, {
                "@type": "Question",
                "name": "Will trust wallet clone script offer huge profits?",
                "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "This trust wallet clone is highly in demand because of its user-friendly and r" +
                            "eliable wallet for traders."
                }
            }
        ]
    }
