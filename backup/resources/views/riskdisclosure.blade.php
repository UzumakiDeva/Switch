...
<section class="risk-dis">
    ...
    <div class="risk-content">
            ...
            <div class="risk-full">
                ...
                <div class="para">
                    <p class="trade-para">
                        ...
                        your Panther Exchange Account. The traded price of Digital Tokens can fluctuate
                        ...
                        Token by Panther Exchange or External Account providers or other service
                        providers, and other factors outside the control of Panther Exchange. Under
                        ...
                        Panther Exchange may suspend trading in or cease to offer Services in respect of
                        any of the Digital Tokens at any time at Panther Exchange’s sole discretion. You
                        may be unable to withdraw Digital Tokens prior to Panther Exchange’s ceasing to
                        offer Services in respect of any such Digital Tokens, resulting in the loss of
                        any such Digital Tokens remaining in your Panther Exchange Account. This brief
                ...
                <div class="para">
                    ...
                    <p class="trade-para">You acknowledge that Panther Exchange shall not be
                ...
                <div class="para">
                    ...
                    <p class="trade-para">If an order, trade or transfer is based on a Manifest
                        ...
                        the basis of Manifest Error, Panther Exchange may (but is not obliged to), at
                        ...
                        <div class="para">
                            <li>
                                <p class="trade-para">
                                    ...
                                    be prejudiced by any action or omission of Panther Exchange in this regard, and
                                    you accept that you have no recourse whatsoever against Panther Exchange.
                                </p>
                            </li>
                        </div>
                ...
                <div>
                    <h5 class="head-txt">
                        ...
                        Panther Exchange Accounts</span>
                    </h5>
                </div>
                
                <div class="para">
                    <span class="number">3.1</span>
                    <p class="trade-para">The Services and/or the Panther Exchange Accounts and the
                        Funds held therein may be subject to attacks on their security, integrity or
                        operation, and you acknowledge and agree that Panther Exchange shall not be
                ...
                <div class="para">
                    ...
                    <p class="trade-para">4.4 Panther Exchange may not support related side chains
                ...
                <div class="para">
                    ...
                    <p class="trade-para">5.5 Panther Exchange may cease offering Services in
                ...
                <div class="para">
                    ...
                    <p class="trade-para">The risks described in this Risk Disclosure Statement may
                        ...
                        hereby accept and agree that Panther Exchange will, at all times, have no
                        ...
                        against Panther Exchange and their respective directors, members, officers,
                ...
                <div class="para">
                    ...
                    <p class="trade-para">
                        Panther Exchange’s decision to support transfer, storage or trading of any
                        particular Digital Token through the Services does not indicate Panther
                        ...
                        Panther Exchange does not in any way make any representation or warranty as to
                        ...
                        Panther Exchange's decision to provide Services in respect of a particular
        ...
        <h4 class="team-txt">The Panther Exchange Team </h4>
