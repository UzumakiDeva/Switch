...
class Coinwithdraw extends Model
{
    ...
    public static function createTransaction($uid,$coin,$fromaddress,$toaddress,$amount,$fee,$ramount,$status=0,$network,$tag=null,$mtype='Web',$remark=null){
