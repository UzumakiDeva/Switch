...
{   
    ...
    {   
        ...
        if($twofa == 'google'){
            ...
            $user->save();
            return response()->json(['success'=>true ,'result'=>$secret ,'message'=>'Enter your OTP']);
        }else if($twofa == 'email'){
            ...
            try 
            {
                ...
                return response()->json(['success' =>true, 'result'=>$rand ,'message'=>'Check your email for verification code!.']);
            } 
            catch (Exception $e)
            {
                dd($e);
    ...
    public function validateOTP(Request $request){
        ...
        if($user->twofa =='google_otp'){            
            ...
            if($data){
                ...
                return response()->json(['success'=>true,'result'=>NULL,'message'=>'Google Two factor authentication is enable']);
            } else {
                $user->twofa ="";
                $user->save();   
